# Insulator damage dataset 800 pieces suitable for insulator defect detection and target detection model

# Body

Insulator Damage Data Set, 800 pieces, suitable for insulator defect detection and target detection model training
seconds after taking a picture， or purchase
just take a picture, ～(D039-1
